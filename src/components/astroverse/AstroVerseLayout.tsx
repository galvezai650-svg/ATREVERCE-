...
function Models3DPage() {
  ...
  const planets = [
    ...
    { name: 'Tierra', gradient: 'from-cyan-400 to-blue-600', size: '12,756 km', desc: 'Nuestro hogar, el planeta azul. Único planeta conocido con vida y agua líquida en su superficie.', moons: 1, dayLength: '24 horas', color: '#00d4ff' },
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-white/40 text-sm mt-1">Estamos trabajando en modelos 3D detallados de cada planeta. ¡Muy pronto podrás explorarlos!</p>
          </div>
